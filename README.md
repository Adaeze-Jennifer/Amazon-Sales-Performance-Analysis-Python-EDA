...
This project analyses over 50,000 Amazon sales transactions from January 2022 to November 2023, covering six product categories across four global regions. The analysis explores key metrics, trends, and relationships to uncover actionable business insights and performance patterns.

## 🔍 Overview
The project focuses on performing Exploratory Data Analysis (EDA) on Amazon sales data using Python. It identifies key patterns in sales performance, revenue distribution, and customer behaviour, with insights communicated through clear and effective data visualisations.
...
![Sales Trend](images/01_sales_trend.png)
...
![Product Category](images/02_product_category_performance.png)
...
## 📒Project Notebook 
- [**View Full Analysis**](https://github.com/Adaeze-Jennifer/Amazon-Sales-Performance-Analysis-Python-EDA/blob/main/project%20files/Amazon%20sales%20performance.ipynb) - This notebook presents a comprehensive analysis of Amazon sales data using Python.
- [**View Full Repository**](https://github.com/Adaeze-Jennifer/Amazon-Sales-Performance-Analysis-Python-EDA/tree/main) - Full documentation, insights, and project breakdown.
- [_Back to Top_](#amazon-sales-performance-analysis-report) - Project overview and documentation
